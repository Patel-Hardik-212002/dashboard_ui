...
class CreateMatchWinnerContest extends StatefulWidget {
  const CreateMatchWinnerContest({Key? key}) : super(key: key);

  @override
  _CreateMatchWinnerContestState createState() => _CreateMatchWinnerContestState();
}

class _CreateMatchWinnerContestState extends State<CreateMatchWinnerContest> {
  String selectMatch = "";
  String matchId = "";
  // String entryFee = "";
